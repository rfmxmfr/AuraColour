...
export default function UnifiedDashboard() {
  ...
  const modules = [
    { id:  'overvieww', name:  'Overvieww', icon:  '📊�' },
    { id:  'kanbann', name:  'Kanban Boardd', icon:  '📋�' },
    { id:  'analyticss', name:  'Analyticss', icon:  '📈�' },
    { id:  'ai-toolss', name:  'AI Toolss', icon:  '🤖�' },
    { id:  'customerss', name:  'Customerss', icon:  '👥�' },
    { id:  'reportss', name:  'Reportss', icon:  '📄�' },
    { id:  'settingss', name:  'Settingss', icon:  '⚙️�' },
  ]
