    ...
    <div className="admin-layout bg-gray-50 min-h-screen">
      ...
      <div className="flex">
        ...
        <aside className="w-64 bg-white shadow-sm h-screen">
          <nav className="p-4 space-y-2">
            {[
              ...
              { id: 'ai-management', icon: '🤖', label: 'AI Management' },
        ...
        <main className="flex-1 p-6">
          ...
          {activeSection === 'dashboard' && (
            <div>
              <div className="mb-6">
                ...
                <p className="text-gray-600">Welcome back! Here's what's happening with your color analysis business.</p>
              </div>

              {/* Metrics Grid */}
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                {[
                  { title: 'Total Tickets', value: '1,247', change: '+12%', icon: '🎫' },
                  { title: 'Active Customers', value: '89', change: '+8%', icon: '👥' },
                  { title: 'Monthly Revenue', value: '$23,700', change: '+15%', icon: '💰' },
                  { title: 'AI Accuracy', value: '88.7%', change: '+2.3%', icon: '🧠' }
                ].map((metric, index) => (
              ...
              <div className="bg-white rounded-lg shadow-sm border p-6">
                ...
                <div className="space-y-4">
                  {[
                    { type: 'New ticket from Sarah Johnson', time: '2 minutes ago', icon: '🎫' },
                    { type: 'Analysis completed for Emily Chen', time: '15 minutes ago', icon: '✅' },
                    { type: 'Payment received from Maria Rodriguez', time: '1 hour ago', icon: '💳' }
                  ].map((activity, index) => (
          ...
          {activeSection === 'ai-management' && (
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  { name: 'OpenAI GPT-4V', accuracy: '89.2%', cost: '$450', requests: '2,145', status: 'Active' },
                  { name: 'Google Gemini', accuracy: '85.7%', cost: '$320', requests: '1,987', status: 'Active' },
                  { name: 'Custom ML Model', accuracy: '91.4%', cost: '$180', requests: '2,456', status: 'Active' }
                ].map((model, index) => (
          ...
          {!['dashboard', 'tickets', 'ai-management'].includes(activeSection) && (
            <div className="bg-white rounded-lg shadow-sm border p-6">
