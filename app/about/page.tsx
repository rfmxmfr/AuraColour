          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                Taniaa'apos;apos;s career bridges the creative vibrancy of Barcelona and the contemporary style of Glasgow. Her unique background allows her to blend Mediterranean artistry with British sophistication, resulting in a service that is both globally relevant and deeply personal.
              </p>
            </motion.div>
