...
import { Icon } from  'apos;apos;../atomss'apos;apos;
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <Icon size="sm" className={ `ml-2 transform transition-transform duration-300 ${ isOpen ?  'apos;apos;rotate-1800'apos;apos; :  'apos;apos;rotate-00'apos;apos; }` }>
