...
VALUES 
  ('12-Season Color Analysis', 'Discover your optimal color palette based on your natural coloring', 75.00, 60),
  ('Virtual Wardrobe Curation', 'Get personalized wardrobe recommendations', 100.00, 90),
  ('Personal Shopping Service', 'One-on-one shopping assistance', 150.00, 120),
